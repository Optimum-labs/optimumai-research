  ...
  return (
    <div className="optimumai__header--body">
      <div className="section__padding" id="home">
        <div className="optimumai__header">
          <div className="optimumai__header-content">
            ...
            <p>
              Your personal AI companion for everyday life. From honing your
              soft skills to acing your next job interview, from maintaining
              mental wellness to planning your finances, we’ve got you covered.
              Discover a world of possibilities, and let us help you navigate
